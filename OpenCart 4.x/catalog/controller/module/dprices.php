...
namespace Opencart\Catalog\Controller\Extension\DPrices\Module;
class DPrices extends \Opencart\System\Engine\Controller {
    ...
    public function index($setting): string {
        ...
        if (isset($setting['prices'][$language_id])) {
            ...
            $this->document->addStyle(HTTP_SERVER . 'extension/dprices/catalog/view/javascript/module-dprices/dprices.css');
    ...
    protected function validate(): bool {
        ...
        /* if (mb_strlen($this->request->post['message']) < 3) {
        ...
        if(isset($this->request->post['ccode'])) {
            ...
            if ($captcha_code == $this->config->get('module_dprices_captcha_ed_ec')) {
                ...
                $extension_info = $this->model_setting_extension->getExtensionByCode('captcha', $captcha_code);
